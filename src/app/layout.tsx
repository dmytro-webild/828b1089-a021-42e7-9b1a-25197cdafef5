...
export const metadata: Metadata = {
  title: "Maius Digital | Web Design for Local Businesses",
  description: "Professional web design for local businesses. High-converting websites that attract more customers. Get your free website audit today.",
  keywords: "web design, local business website, professional website design, lead generation, small business web design",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Maius Digital | Web Design for Local Businesses",
    description: "Turn Your Business Into a Lead-Generating Machine. Professional websites designed to attract and convert customers.",
    type: "website",
    siteName: "Maius Digital",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/businessman-near-glass-building-looking-camera_23-2148308621.jpg",
        alt: "Professional web design for local businesses",
      },
    ],
  },
  twitter: {
    ...
    title: "Maius Digital | Web Design for Local Businesses",
    description: "Professional websites that attract more customers and generate leads for your business.",
  },
};
